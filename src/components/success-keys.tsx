...
export const successKeyItems: SuccessKeyItem[] = [
  {
    ...
    checkoutUrl: "https://www.ggcheckout.com/checkout/v2/pFRxRb0fZMzGXLRCSI6x",
    icon: "🥇",
  ...
  },
  {
    ...
    checkoutUrl: "https://www.ggcheckout.com/checkout/v2/F8lgIysU3Gt9SxLuPXMD",
    icon: "⭐",
  ...
  },
  {
    ...
    price: "9,90",
    checkoutUrl: "https://www.ggcheckout.com/checkout/v2/tsUu4uNA5BSueBTJkdVW",
    icon: "📜",
  ...
  },
  {
    ...
    price: "9,90",
    checkoutUrl: "https://www.ggcheckout.com/checkout/v2/gUA6EXtGDHqlalOvNqVv",
    icon: "⚡️",
  ...
  },
  {
    ...
    price: "6,99",
    checkoutUrl: "https://www.ggcheckout.com/checkout/v2/D5wa7bBjkpERDCubmq4k",
    icon: "🗓️",
